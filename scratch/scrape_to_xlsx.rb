...
# We limit to exactly the first 2 products for review, as requested by the user
target_containers = product_containers.first(2)
puts "Found #{product_containers.size} products. Exporting exactly #{target_containers.size} products for review."
